...
def main():
    ...
    selection_method = [tools.selTournament, tools.selRoulette]
    crossover_method = [tools.cxOnePoint,tools.cxTwoPoint]

    results = []  # List to store the results
    
    for select in selection_method:
        for mate in crossover_method:
